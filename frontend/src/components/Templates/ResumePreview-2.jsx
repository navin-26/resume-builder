...
const ResumePreview = ({ data }) => {
  ...
  return (
    <div className="border p-12 py-14 rounded bg-white font-sans text-sm mx-auto overflow-hidden text-gray-800 text-[15px] font-medium h-[1000px]">
      <div className="text-center mb-6 border-b pb-4 border-purple-950 text-red-700">
      ...
      <h3 className="text-[18px] mt-3 pb-2 uppercase text-red-700 font-bold">SUMMARY</h3>
      <p className="mb-4">{previewData.summary}</p>

      <h3 className="text-[18px] font-bold my-6 pt-4 uppercase border-t border-purple-950 text-red-700">EDUCATION</h3>
      ...
      <h3 className="text-[18px] font-bold my-5 border-t pb-3 pt-6 border-purple-950 uppercase text-red-700">EXPERIENCE</h3>
      ...
      <h3 className="text-[18px] font-bold mt-4 pb-1 uppercase text-red-700">SKILLS</h3>
      ...
      <h3 className="text-[18px] font-bold mt-4 pb-1 uppercase text-red-700">PROJECTS</h3>

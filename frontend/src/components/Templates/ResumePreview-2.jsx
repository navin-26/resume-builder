...
const ResumePreview = ({ data }) => {
  ...
  return (
    <div className='border h-[11.69in] p-12 py-14 rounded bg-[#fcfced] font-sans text-sm mx-auto overflow-hidden text-[#331900] text-[13px] font-medium relative'>
      <div className='flex flex-row justify-between space-x-14 py-10 px-3 border-b border-gray-800 relative'>
        <div className='relative'>
            ...
            <h2 className="text-[40px] font-bold uppercase mb-5 relative z-10">{previewData.fname}</h2>
            <h2 className="text-[40px] font-bold uppercase mb-5 relative z-10">{previewData.lname}</h2>
        ...
        <div className='flex flex-col from-neutral-600s'>
          <p className="text-lg flex items-center relative">
      ...
      <div className='flex flex-col justify-between px-3 mt-2 border-b border-gray-800'>
        <h2 className='font-bold text-[18px] mb-4 '>ABOUT ME</h2>
        <p className="mb-4">{previewData.summary}</p>
      </div>
      <div className='flex flex-row  px-3 border-b border-gray-800'>
        <div className='w-1/2'>
          <h3 className="text-[18px] font-bold my-3 py-3  uppercase text-black">EXPERIENCE</h3>
        ...
        <div className='w-1/2'>
        <h3 className="text-[18px] font-bold my-3 py-3  uppercase text-black ">Education</h3>
      ...
      <div className="border-b border-gray-800 px-3">
            <h3 className="text-[18px] font-bold mt-4 pb-1 uppercase text-black ">SKILLS</h3>
        ...
        <h3 className="text-[18px] font-bold mt-4 pb-1 uppercase text-black px-3 ">PROJECTS</h3>
            <div className="px-3">

...
const ResumePreview = ({ data }) => {
  ...
  return (
    <div className="border  h-[1000px] pl-12 py-10 rounded bg-white font-sans text-sm mx-auto overflow-hidden text-gray-800 text-[15px] font-medium" style={{color:'#313c4e'}}>
